...
fastqc data/*.fastq.gz --outdir qc --threads 4
````
...
Uneven tiles can indicate instrument issues or bubble formation, but this module rarely shows problems in modern NovaSeq data.
