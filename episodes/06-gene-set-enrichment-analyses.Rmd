...
```{r, fig.cap="GO Biological Process enrichment dotplot for upregulated genes", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/06-enrich/go-bp-up.png")
```
...
```{r, fig.cap="GO Biological Process enrichment barplot for upregulated genes", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/06-enrich/go-bp-up-bar.png")
```
...
knitr::include_graphics("fig/06-enrich/go-bp-up-simple.png")
```

```{r, fig.cap="Simplified GO Biological Process enrichment barplot", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/06-enrich/go-bp-up-bar-simple.png")
```
...
knitr::include_graphics("fig/06-enrich/go-bp-up-enrichment-map.png")
```
...
knitr::include_graphics("fig/06-enrich/kegg-bar.png")
```
...
knitr::include_graphics("fig/06-enrich/hallmark1.png")
```
...
knitr::include_graphics("fig/06-enrich/gsea-1.png")
```
...
knitr::include_graphics("fig/06-enrich/gsea-2b.png")
```
