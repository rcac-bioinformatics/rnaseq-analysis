...
```{r, fig.cap="Basic gene annotation in GTF format", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/01_fq2counts/gencode-gtf.png")
```
...
```{r, fig.cap="Reference genome file in FASTA format", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/01_fq2counts/gencode-genome.png")
```
...
```{r, fig.cap="Transcript sequences file in FASTA format", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/01_fq2counts/gencode-transcripts.png")
```
...
```{r, fig.cap="FASTQ files from GEO", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/01_fq2counts/geo-db.png")
```
...
```{r, fig.cap="FASTQ files from SRA Run Selector", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/01_fq2counts/srr-runs.png")
```
