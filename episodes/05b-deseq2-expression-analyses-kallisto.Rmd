...
```{r, fig.cap="Raw count distributions", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/05_deseq/raw-count-k.png")
```
...
```{r, fig.cap="Count density distributions", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/05_deseq/count-density-k.png")
```
...
```{r, fig.cap="Sample distance heatmap", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/05_deseq/pheatmap-k.png")
```
...
```{r, fig.cap="PCA plot of Kallisto-quantified samples", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/05_deseq/pcaplot-k.png")
```
...
knitr::include_graphics("fig/05_deseq/plotdispests-k.png")
```
...
```{r, fig.cap="Volcano plot of differential expression results", echo=FALSE, message=FALSE}
knitr::include_graphics("fig/05_deseq/volcano-k.png")
```
